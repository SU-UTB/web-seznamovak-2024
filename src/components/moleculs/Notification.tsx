    ...
    <div className="px-4 lg:px-0 flex flex-col items-center w-full">
      ...
      {isPreRegistrationActive && (
        <a
          ...
          className="bg-darkPink text-beige text-3xl rounded-[8px] mt-4 px-6 py-3 inline-block text-center font-semibold transition hover:bg-beige hover:text-darkPink duration-300"
        >
          CHCI UPOZORNĚNÍ
        </a>
      )}
